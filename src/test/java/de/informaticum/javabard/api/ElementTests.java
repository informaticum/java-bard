...
public class ElementTests {
    ...
    public static List<Function<String, TypeDeclaration>> codeFactories() {
        final Function<String, TypeDeclaration> dec = (n) -> declare(Kind.CLASS, n);
        final Function<String, TypeDeclaration> con = (n) -> new TypeDeclaration(Kind.CLASS, n);
        final Function<String, TypeDeclaration> set = (n) -> new TypeDeclaration(Kind.CLASS, n).setName(n);
    ...
    private TypeDeclaration make(final Enum<?> enumm) {
        return this.make(enumm.name().toLowerCase(Locale.US));
    }
